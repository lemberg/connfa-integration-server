...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="pull-left">
                {!! Breadcrumbs::render('breadcrumbs', [['label'=> trans('Floor plans'), 'route' => 'floors.index', 'params' => ['conference_alias' => $conference->alias]], ['label'=> trans('Edit floor plan'), 'route' => 'floors.index', 'params' => ['conference_alias' => $conference->alias]]]) !!}
            </div>
            <div class="x_panel">
                <div class="x_title">
                ...
                <div class="x_content">
                    <br />
                    {!! Form::open(['route' => ['floors.update', 'id' => $data->id, 'conference_alias' => $conference->alias], 'files' => true, 'method' => 'PUT', 'class' => 'form-horizontal form-label-left']) !!}
