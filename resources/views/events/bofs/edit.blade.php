...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="pull-left">
                {!! Breadcrumbs::render('breadcrumbs', [['label'=> trans('BOF events'), 'route' => 'bofs.index'], ['label'=> trans('Edit BOF event'), 'route' => 'bofs.index']]) !!}
            </div>
            <div class="x_panel">
                <div class="x_title">
                ...
                <div class="x_content">
                    <br/>
                    {!! Form::open(['route' => ['bofs.update', 'id' => $data->id], 'method' => 'PUT', 'class' => 'form-horizontal form-label-left']) !!}
                        ...
                        <div class="form-group{{ $errors->has('order') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{ Form::number('order', $data->order, ['class' => 'form-control col-md-7 col-xs-12', 'step' => '10']) }}
                                @if ($errors->has('order'))
                                    <span class="help-block">
