...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="pull-left">
                {!! Breadcrumbs::render('breadcrumbs', [['label'=> trans('BOF events'), 'route' => 'bofs.index', 'params' => ['conference_alias' => $conference->alias]], ['label'=> trans('Create BOF event'), 'route' => 'bofs.index', 'params' => ['conference_alias' => $conference->alias]]]) !!}
            </div>
            <div class="x_panel">
                <div class="x_title">
                ...
                <div class="x_content">
                    <br/>
                    {!! Form::open(['route' => ['bofs.store', 'conference_alias' => $conference->alias], 'method' => 'POST', 'class' => 'form-horizontal form-label-left']) !!}
