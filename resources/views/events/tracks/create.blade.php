...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="pull-left">
                {!! Breadcrumbs::render('breadcrumbs', [['label'=> trans('Tracks'), 'route' => 'tracks.index'], ['label'=> trans('Create track'), 'route' => 'tracks.index']]) !!}
            </div>
            <div class="x_panel">
                <div class="x_title">
                ...
                <div class="x_content">
                    <br />
                    {!! Form::open(['route' => ['tracks.store'], 'method' => 'POST', 'class' => 'form-horizontal form-label-left']) !!}
