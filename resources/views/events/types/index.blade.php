                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        <thead>
                            <tr class="headings">
                                ...
                                <th class="column-title" style="width: 25%">{{ trans('Name') }}</th>
                                <th class="column-title" style="width: 25%">{{ trans('Order') }}</th>
                                <th class="column-title" style="width: 25%">{{ trans('Icon') }}</th>
