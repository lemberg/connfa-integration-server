...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="pull-left">
                {!! Breadcrumbs::render('breadcrumbs', [['label'=> trans('Types'), 'route' => 'types.index', 'params' => ['conference_alias' => $conference->alias]], ['label'=> trans('Create type'), 'route' => 'types.index', 'params' => ['conference_alias' => $conference->alias]]]) !!}
            </div>
            <div class="x_panel">
                <div class="x_title">
                ...
                <div class="x_content">
                    <br/>
                    {!! Form::open(['route' => ['types.store', 'conference_alias' => $conference->alias], 'files' => true, 'method' => 'POST', 'class' => 'form-horizontal form-label-left']) !!}
