...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="pull-left">
                {!! Breadcrumbs::render('breadcrumbs', [['label'=> trans('Levels'), 'route' => 'levels.index'], ['label'=> trans('Create level'), 'route' => 'levels.index']]) !!}
            </div>
            <div class="x_panel">
                <div class="x_title">
                ...
                <div class="x_content">
                    <br />
                    {!! Form::open(['route' => ['levels.store'], 'method' => 'POST', 'class' => 'form-horizontal form-label-left']) !!}
