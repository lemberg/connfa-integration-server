...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="pull-left">
                {!! Breadcrumbs::render('breadcrumbs', [['label'=> trans('Users'), 'route' => 'users.index', 'params' => ['conference_alias' => $conference->alias]], ['label'=> trans('Edit user'), 'route' => 'users.index', 'params' => ['conference_alias' => $conference->alias]]]) !!}
            </div>
            <div class="x_panel">
                <div class="x_title">
                ...
                <div class="x_content">
                    <br/>
                    {!! Form::open(['route' => ['users.update', 'id' => $data->id, 'conference_alias' => $conference->alias], 'method' => 'PUT', 'class' => 'form-horizontal form-label-left']) !!}
                       ...
                       <div class="change-password" style="{{ empty(old('change_password'))? 'display:none;' : 'display:block;' }}">
                        ...
                        <div class="form-group{{ $errors->has('roles') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{ Form::select('roles', $roles, $data->roles->pluck('id')->toArray(), ['class' => 'form-control col-md-7 col-xs-12 select2_multiple select2_roles', 'multiple' => 'multiple', 'name' => 'roles[]']) }}
                                @if ($errors->has('roles'))
                                    <span class="help-block">
