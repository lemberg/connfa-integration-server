                ...
                <div class="x_content">
                    ...
                    <div class="form-group{{ $errors->has('end_at') ? ' has-error' : '' }} has-feedback">
                        ...
                        <div class="form-group{{ $errors->has('level_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{ Form::select('level_id', ['NULL' => 'Please select the option'] + $levels, 'NULL', ['class' => 'form-control col-md-7 col-xs-12']) }}
                        ...
                        <div class="form-group{{ $errors->has('type_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{ Form::select('type_id', ['NULL' => 'Please select the option'] + $types, 'NULL', ['class' => 'form-control col-md-7 col-xs-12']) }}
                        ...
                        <div class="form-group{{ $errors->has('track_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                {{ Form::select('track_id', ['NULL' => 'Please select the option'] + $tracks, 'NULL', ['class' => 'form-control col-md-7 col-xs-12']) }}
